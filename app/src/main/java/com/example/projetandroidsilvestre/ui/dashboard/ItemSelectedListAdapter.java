...
public class ItemSelectedListAdaper extends RecyclerView.Adapter<ItemSelectedListAdaper.ItemSelectedViewHolder>{
    private ArrayList<String> mDataset;
    private Context mContext;
    private List<RemoveEventListener> removeItemListeners;
    private final LayoutInflater mInflater;
    ...
    // Create new views (invoked by the layout manager)
    @Override
    public ItemSelectedListAdapter.ItemSelectedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        //TextView itemView = (TextView)mInflater.inflate(R.layout.recyclerview_item, parent, false);
        View v = mInflater
                .inflate(R.layout.recyclerview_itemselected, parent, false);
